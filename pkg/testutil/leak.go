...
running(leaking) after all tests.
	...
	import "lucastetreault/did-tangaroa/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "lucastetreault/did-tangaroa/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "lucastetreault/did-tangaroa/pkg/logutil.(*MergeLogger).outputLoop") ||
