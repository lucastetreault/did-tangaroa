...
import (
	...
	"lucastetreault/did-tangaroa/etcdserver/api"
	"lucastetreault/did-tangaroa/etcdserver/api/membership"
	...
	"lucastetreault/did-tangaroa/etcdserver/api/v2http/httptypes"
	stats "lucastetreault/did-tangaroa/etcdserver/api/v2stats"
	"lucastetreault/did-tangaroa/etcdserver/api/v2store"
	"lucastetreault/did-tangaroa/etcdserver/api/v3alarm"
	"lucastetreault/did-tangaroa/etcdserver/api/v3compactor"
	pb "lucastetreault/did-tangaroa/etcdserver/etcdserverpb"
	"lucastetreault/did-tangaroa/lease"
	"lucastetreault/did-tangaroa/lease/leasehttp"
	"lucastetreault/did-tangaroa/mvcc"
	"lucastetreault/did-tangaroa/mvcc/backend"
	"lucastetreault/did-tangaroa/pkg/fileutil"
	"lucastetreault/did-tangaroa/pkg/idutil"
	"lucastetreault/did-tangaroa/pkg/pbutil"
	"lucastetreault/did-tangaroa/pkg/runtime"
	"lucastetreault/did-tangaroa/pkg/schedule"
...
var (
	plog = capnslog.NewPackageLogger("lucastetreault/did-tangaroa", "etcdserver")
