...
import (
	...
	"lucastetreault/did-tangaroa/clientv3/credentials"
	"lucastetreault/did-tangaroa/etcdserver"
	"lucastetreault/did-tangaroa/etcdserver/api/v3client"
	"lucastetreault/did-tangaroa/etcdserver/api/v3election"
	"lucastetreault/did-tangaroa/etcdserver/api/v3election/v3electionpb"
	v3electiongw "lucastetreault/did-tangaroa/etcdserver/api/v3election/v3electionpb/gw"
	"lucastetreault/did-tangaroa/etcdserver/api/v3lock"
	"lucastetreault/did-tangaroa/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "lucastetreault/did-tangaroa/etcdserver/api/v3lock/v3lockpb/gw"
	"lucastetreault/did-tangaroa/etcdserver/api/v3rpc"
	etcdservergw "lucastetreault/did-tangaroa/etcdserver/etcdserverpb/gw"
