...
[![GoDoc](https://godoc.org/lucastetreault/did-tangaroa/client?status.png)](https://godoc.org/lucastetreault/did-tangaroa/client)
...
```bash
go get lucastetreault/did-tangaroa/client
```
